...
def printSudoku(sudoku):
    ...
    str1 = "".join(str(e) for e in row1)
    str2 = "".join(str(e) for e in row2)
    str3 = "".join(str(e) for e in row3)
    str4 = "".join(str(e) for e in row4)
    str5 = "".join(str(e) for e in row5)
    str6 = "".join(str(e) for e in row6)
    str7 = "".join(str(e) for e in row7)
    str8 = "".join(str(e) for e in row8)
    str9 = "".join(str(e) for e in row9)
    ...
    New_Sudoku_String = str1 + str2 + str3 + str4 + str5 + str6 + str7 + str8 + str9
    F = open("Sudoku.txt", "w")
    F.write(New_Sudoku_String)
    F.close()
