...
class PgNode():
    ...
    includes instance sets common to both types of nodes used in a
        planning graph
...
class PgNode_a(PgNode):
    ...
    def precond_s_nodes(self):
        """precondition literals as S-nodes (represents possible parents
        for this node). It is computationally expensive to call this function;
    ...
    def effect_s_nodes(self):
        ...
        it is only called by the class constructor to populate
        the `effnodes` attribute.
...
class PlanningGraph():
    ...
    def create_graph(self):
        ...
        # continue to build the graph alternating A, S levels until last
        # two S levels contain the same literals,
    ...
    def update_a_mutex(self, nodeset):
        ...
        if the planning graph is a serial planning graph and the pair
        are nonpersistence actions or if any of the three conditions
